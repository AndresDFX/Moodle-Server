...
/**
 * [jAdvertencia] Clase de interfaz GUI de ventana modal de dialogos de advertencia
 * @since 24/11/2017
 * @version 2.0
 * @author Julian Andres Castaño - 1625743
 */

public class jAdvertencia extends javax.swing.JDialog {
...
//=======================================================================================================
     ...
     * @since jWarning.java
     */
    public jAdvertencia(java.awt.Frame parent, boolean modal,String texto) 
    {
        super(parent, modal);
        initComponents();
        this.texto=texto;
...
//=======================================================================================================   
    ...
    private void initComponents() {
        ...
        jPanelTitulo.add(jLabelTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, -1, 40));
